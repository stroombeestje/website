...
(function () {
  ...
  const ALL_DIALS = [
    ...
    ["--x-bar", "Bar: height", 0.7, 2.4, 0.01, 1.7, "all"],
    ...
    ["--x-home-lead", "Home: intro & labels", 0.7, 2.2, 0.01, 1, ["home"]],
    ["--x-home-cards", "Home: card titles", 0.7, 2.2, 0.01, 1, ["home"]],
    ...
    ["--pc-scale", "Cloud: size", 0.5, 2.5, 0.05, 0.8, ["home"]],
  ];
